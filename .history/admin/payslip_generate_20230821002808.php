...
<?php
	...
	//The script retrieves the 'date_range' data from a POST request and
	//converts it into proper date formats
	$range = $_POST['date_range'];
	$ex = explode(' - ', $range);
	$from = date('Y-m-d', strtotime($ex[0]));
	$to = date('Y-m-d', strtotime($ex[1]));
	//The script retrieves the total amount of deductions from the 'deductions' table.
	...
	//The script uses the TCPDF library to create a PDF document for each employee's payslip.
