...
//This sets the body class for the page, which relates to a specific UI framework or template.
<body class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">

  <?php include 'includes/navbar.php'; ?> //This includes a navigation bar file, possibly containing 
  //navigation links or menus.
  <?php include 'includes/menubar.php'; ?> //This includes a menu bar file, possibly containing sidebar 
  //menus.
