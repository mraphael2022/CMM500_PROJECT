...
<?php
	...
	// a function that generates rows of employee data for the payroll report. It calculates 
	//net pay based on various deductions and other data.
	...
	//This retrieves the 'date_range' data from a POST request. This is expected to be in the 
	...
	//For payslip generation in pdf format.( i downloaded TCPDF library to create and output in pdf).
    ...
    $content .= '
      ...
      ';  
	  //This calls the generateRow() function to populate the table with employee data
